...
rects1 = ax.bar(ra - 5 * width / 2, PROCLUS_times, width=width, label="PROCLUS", color="#A12C23")
rects2 = ax.bar(ra - 3 * width / 2, FAST_star_PROCLUS_times, width=width, label="FAST*-PROCLUS", color="#00554D")
rects3 = ax.bar(ra - width / 2, FAST_PROCLUS_multi_times, width=width, label="FAST-PROCLUS", color="#0281BB")
rects4 = ax.bar(ra + width / 2, GPU_PROCLUS_times, width=width, label="GPU-PROCLUS", color="#74A23D")
rects5 = ax.bar(ra + 3 * width / 2, GPU_FAST_star_PROCLUS_times, width=width, label="GPU-FAST*-PROCLUS", color="#8BB3FF")
rects6 = ax.bar(ra + 5 * width / 2, GPU_FAST_PROCLUS_multi_times, width=width, label="GPU-FAST-PROCLUS", color="#F19000")
